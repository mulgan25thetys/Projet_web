          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Ajouter une publicite <small>Ici vous pouvez ajouter des publicites</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" method="post" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" action="views/ajoutpublicite.php">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <?php include_once "views/afficherpublicite.php" ?>
                      </tbody>
                    </table>
                  </div>
                </div>
