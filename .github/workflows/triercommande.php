...
<html lang="fr">
  <head>
    ...
    <title>Naturalium | Trier commande</title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td style="color: #44bd32;" class=" "><?php echo $row['qte'];?></td>
                      ...
                      <a href="vidercommande.php?vider=1" style="font-size: 20px; font-weight: bold;color: #44bd32;">Vider les commandes</a>
                    </div>
