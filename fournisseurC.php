...
class fournisseurC {
	function ajouterfournisseur($fournisseur){
		$sql="insert into fournisseur (nom,prenom,adresse,email,categorie) values (:nom, :prenom,:adresse,:email,:categorie)";
	...
	function modifierfournisseur($fournisseur,$id_fournisseur){
		$sql="UPDATE fournisseur SET nom=:nom, prenom=:prenom, adresse=:adresse, email=:email, categorie=:categorie WHERE id_fournisseur=:id_fournisseur";
